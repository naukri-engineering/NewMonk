    ...
    private function getIpAddress($match, $pdoDb = true)
    {
        ...
        if(count($srvRecords) > 0)
        {
            ...
            if($port && $host){
                ...
                throw new DnsResolverException("Not able to find dns record for 1: ". $match);
            }
            ...
            if(count($hostIps) > 0)
            {
                ...
                throw new DnsResolverException("Not able to find dns record for 2: ". $match);

            return "";
        }
        else
            throw new DnsResolverException("Not able to find dns record for 3: ". $match);
